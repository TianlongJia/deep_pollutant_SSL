...
srun python tools/object_detection_benchmark_1.py \
    --config-file /scratch/tjian/PythonProject/deep_pollutant_SSL/configs/config/benchmark/object_detection/COCOInstance/Pollutant_MaskRCNN/Train_80%.yaml \
     --num-gpus 1 SOLVER.MAX_ITER 4500 TEST.EVAL_PERIOD 45 SOLVER.IMS_PER_BATCH 4 MODEL.BACKBONE.FREEZE_AT 4 MODEL.WEIGHTS /scratch/tjian/PythonProject/deep_pollutant_SSL/checkpoints/train_weights/Self_train/RN50_Sw_100e_FTAL/detectron2/RN50_Sw_100e_FTAL.torch OUTPUT_DIR /scratch/tjian/PythonProject/deep_pollutant_SSL/checkpoints/train_weights/SSL_SwAV_FTAL_F4/Train_80%/
